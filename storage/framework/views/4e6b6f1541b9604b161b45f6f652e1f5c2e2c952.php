...
<head>
  ...
  <link href="<?php echo e(asset('css/blog-master.css')); ?>" rel="stylesheet">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <!-- EACH MENU -->
      <div id="side-menu" class="side-nav">
        ...
        <a href="<?php echo e(route('admin.orders')); ?>">ORDER</a>
    ...
    <div class="container navtab">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            <?php if(Auth::guard('admin')->check()): ?>
            <li class="nav-item nav-signin"><a class="nav-link" href="<?php echo e(route('admin.logout')); ?>">SIGN OUT</a></li> <!-- IF ALREADY SIGN IN -->
            <?php else: ?> 
            <li class="nav-item nav-signin"><a class="nav-link" href="<?php echo e(route('admin.signin')); ?>">SIGN IN</a></li> <!-- IF NOT SIGN IN YET -->
            <?php endif; ?>
          </ul>
        </div>
...
</html><?php /**PATH E:\EDUCATION\YEAR 3\PROJECT DATABASE\SPRINT 2 0872\WEBDEV\DB-Library_Petch_Part\resources\views/create/categories.blade.php ENDPATH**/ ?>